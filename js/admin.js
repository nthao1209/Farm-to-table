            ...
            <div class="list">
                ...
                <div class="list-right">
                    <div class="list-price">
                        <span class="list-current-price">${formatPriceWithUnit(product.price, product.unit)}</span>                      </div>
...
function editProduct(id) {
    ...
    document.getElementById("don-vi-tinh").value = products[index].unit;
...
btnUpdateProductIn.addEventListener("click", (e) => {
    ...
    let unitProduct = products[indexCur].unit;
    ...
    let unitProductCur = document.getElementById("don-vi-tinh").value;
    if (imgProductCur != imgProduct || titleProductCur != titleProduct || curProductCur != curProduct || descProductCur != descProduct || categoryText != categoryProduct|| unitProductCur != unitProduct) {
        let productadd = {
            id: idProduct,
...
btnAddProductIn.addEventListener("click", (e) => {
    ...
    let donviTinh = document.getElementById("don-vi-tinh").value;
