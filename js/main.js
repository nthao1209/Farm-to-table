...
// *** HÀM MỚI: Định dạng giá kèm đơn vị ***
function formatPriceWithUnit(price, unit) {
    const formattedPrice = vnd(price);
    // Nếu sản phẩm có đơn vị (unit) thì ghép vào, nếu không thì chỉ trả về giá
    if (unit && unit.trim() !== '') {
            ...
            currentuser.cart.forEach(item => {
                ...
                <div class="cart-item-info">
                    ...
                    <span class="cart-item-price price" data-price="${product.price}">
                        ${formatPriceWithUnit(parseInt(product.price), product.unit)}
                    </span>
                </div>
                ...
                productHtml += `<div class="order-history">
                    ...
                    <div class="order-history-right">
                        <div class="order-history-price">
                            <span class="order-history-current-price">${formatPriceWithUnit(sp.price, infosp.unit)}
                            </span>                       
                         </div>                         
                    </div>
                </div>`;
